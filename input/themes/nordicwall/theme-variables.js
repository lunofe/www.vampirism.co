...
let fontParams = {
  ...
  output += `    
    :root {
      ...
      --font-weight-semibold:       ${params.fontSemiboldWeight}; 
      ...
      --headings-word-spacing:      0;
      --headings-line-height:       ${params.fontHeadingsLineHeight};
      --hero-content-width:         ${params.heroContentWidth};
      --hero-slide-spacing:         0;
      --hero-slide-size:            100%;
      --hero-aspect-ratio-sm:       ${params.heroAspectRatioPhone === 'custom' ? params.customheroAspectRatioPhone : params.heroAspectRatioPhone};
      --hero-aspect-ratio-md:       ${params.heroAspectRatioTablet === 'custom' ? params.heroAspectRatioTablet : params.heroAspectRatioTablet};
      --hero-aspect-ratio-lg:       ${params.heroAspectRatioDesktop === 'custom' ? params.customHeroAspectRatioDesktop : params.heroAspectRatioDesktop};
      --hero-image-object-fit:      ${params.heroImageObjectFit};
      --content-image-aspect-ratio-sm: ${params.contentAspectRatioMobile === 'custom' ? params.customContentAspectRatioMobile : params.contentAspectRatioMobile};
      --content-image-aspect-ratio-md: ${params.contentAspectRatioTablet === 'custom' ? params.customContentAspectRatioTablet : params.contentAspectRatioTablet};
      --content-image-aspect-ratio-lg: ${params.contentAspectRatioDesktop === 'custom' ? params.customContentAspectRatioDesktop : params.contentAspectRatioDesktop};
      --content-image-object-fit:   ${params.contentObjectFit};
      --card-image-aspect-ratio-sm: ${params.cardsAspectRatioMobile === 'custom' ? params.customCardsAspectRatioMobile : params.cardsAspectRatioMobile};
      --card-image-aspect-ratio-lg: ${params.cardsAspectRatioDesktop === 'custom' ? params.customCardsAspectRatioDesktop : params.cardsAspectRatioDesktop};
      --card-image-object-fit:      ${params.cardsObjectFit};
      --tile-image-aspect-ratio-sm: ${params.tilesAspectRatioMobile === 'custom' ? params.customTilesAspectRatioMobile : params.tilesAspectRatioMobile};
      --tile-image-aspect-ratio-md: ${params.tilesAspectRatioTablet === 'custom' ? params.customTilesAspectRatioTablet : params.tilesAspectRatioTablet};
      --tile-image-aspect-ratio-lg: ${params.tilesAspectRatioDesktop === 'custom' ? params.customTilesAspectRatioDesktop : params.tilesAspectRatioDesktop};
      --tile-image-object-fit:      ${params.tilesObjectFit};
      --tile-content-width:         ${params.tilesContentWidth};
      --backdrop-filter:            ${params.tilesBackdropFilter};
      --section-title-width:        ${params.sectionTitleWidth};   
    `;
  ...
  if (params.colorScheme !== 'dark') {
    output += ` 
        ...
        --text-color-light:   ${params.textColorLight};  
        --headings-color:     ${params.headingsColor}; 
        --link-color:         ${params.linkColor}; 
        --link-color-hover:   ${params.linkHoverColor};    
        --nav-link-color:     ${params.navLinkColor}; 
        --nav-link-color-hover: ${params.navLinkHoverColor};  
        --backdrop-bg:        ${params.tilesBackdropBackground};  
        --logo-color:         #141416;   
        --highlight-color:    #FFC700;
        --info-color:         #67B1F3;
        --success-color:      #00A563;
        --warning-color:      #EE4E4E;
        --shadow:             0 0 3px 0 rgba(0,0,0,.1);
        --shadow-submenu:     0 0 2px 0 rgba(0, 0, 0, .2);
        --code-color:         #C84B31;
    `;
  }
  ...
  if (params.colorScheme === 'dark') {
    output += ` 
        ...
        --text-color-light:   ${params.textDarkColorLight};  
        --headings-color:     ${params.headingsDarkColor}; 
        --link-color:         ${params.linkDarkColor}; 
        --link-color-hover:   ${params.linkDarkHoverColor};    
        --nav-link-color:     ${params.navDarkLinkColor}; 
        --nav-link-color-hover: ${params.navDarkLinkHoverColor}; 
        --backdrop-bg:        ${params.tilesBackdropDarkBackground}; 
        --logo-color:         #FFFFFF;   
        --highlight-color:    #FFBC6C;
        --info-color:         #5B9ED5;
        --success-color:      #54A468;
        --warning-color:      #FB6762;
        --shadow:             0 0 3px 0 rgba(0,0,0,.1);
       	--shadow-submenu:     0 0 2px 0 rgba(255, 255, 255, .2);
        --code-color:         #FFBC6C;
    `;
  }
  ...
  if (params.imagePlaceholder) {
    output += `     
     :root { 
          --image-placeholder: var(--lightest);
        }
    `;
  }
